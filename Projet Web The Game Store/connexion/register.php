            ...
            <div class="register">
                <form action="inscription.php" method="POST" onsubmit="return verifier()">
                    ...
                    <div class="errormessage">
                        ...
                        <span class="erreur" id="errpwd">*Le mot de passe ne réponds pas aux critères (doit contenir au moins, 12 caractère, 1 majuscule et 1 minuscule, 1 caractère spécial) </span>
                        <span class="erreur" id="checkpwd">*Les mots de passe ne sont pas identique </span>
                        <!-- Champs vides -->
